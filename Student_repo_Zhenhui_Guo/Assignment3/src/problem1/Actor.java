...
/**
 * Represents details of an actor, including name, age, active years, genre, awards,
 * movies, series and other multimedia.
 */
public class Actor extends AbstractArtistsActorDanceFilmmaker {
  /**
   ...
   */
  public Actor(Name name, int age, String activeYears,
