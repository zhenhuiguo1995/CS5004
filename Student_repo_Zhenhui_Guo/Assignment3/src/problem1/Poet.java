...
/**
 * Represents details of a poet, including name, age, active years, genre, awards.
 */
public class Poet extends AbstractArtists {
   ...
   */
  public Poet(Name name, int age, String activeYears,
