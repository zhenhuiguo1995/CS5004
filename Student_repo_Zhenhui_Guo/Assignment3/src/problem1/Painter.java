...
/**
 * Represents details of a painter, including name, age, active years, genre, awards.
 */
public class Painter extends AbstractArtists {
   ...
   */
  public Painter(Name name, int age, String activeYears,
