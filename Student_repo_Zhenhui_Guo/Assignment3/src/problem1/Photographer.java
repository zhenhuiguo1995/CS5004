...
/**
 * Represents details of a photographer, including name, age, active years, genre, awards.
 */
public class Photographer extends AbstractArtists {
   ...
   */
  public Photographer(Name name, int age, String activeYears,
